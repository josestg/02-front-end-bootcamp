const Card = () => {
  return (
    <div className="max-w-md mx-auto bg-white  dark:bg-slate-900 rounded-xl shadow-md overflow-hidden md:max-w-2xl">
      <div className="md:flex">
        ...
        <div className="p-8">
          ...
          <a
            href="#"
            className="block mt-1 text-lg leading-tight font-medium text-black  dark:text-slate-100 hover:underline"
          >
